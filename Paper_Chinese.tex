...
\author{
    ...
    译者: 崔广斌, guangbincui@gmail.com; 高天露, tianlu.jorden.gao@gmail.com
}
\begin{document}
...
本文的中文源文件维护在 \url{https://github.com/cuiguangbin/ethereum_yellowpaper}。一个自动生成的中文 PDF 格式文件见 \url{https://github.com/cuiguangbin/ethereum_yellowpaper/blob/master/Paper_Chinese.pdf}。 (本段由译者增加)
